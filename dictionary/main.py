...
print('You are able to get information about the program with typing "-options"\n')
len_words_mean_list = len(words_mean)
len_words_mean_list_2 = len(words_mean_2)

users_word = input("Please enter a word: ").lower().lower()
...
def main_fun():
    ...
    while it_should_continue:
        if (users_word == "-exit" or users_word == "-cur" or users_word == "-c" or users_word == "-release" or
                users_word == "-about" or users_word == "-options" or users_word == "-cont"):
            checking()
